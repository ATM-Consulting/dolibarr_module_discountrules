...
function _exportProductsPrices()
{
	...
	$arrayfields = array(
		...
		'p.fk_product_type'=>array('label'=>$langs->transnoentities("Type"), 'checked'=>0, 'enabled'=>(isModEnabled('product') && isModEnabled('service')), 'position'=>11),'p.sellprice'=>array('label'=>$langs->transnoentities("BaseSellingPrice"), 'checked'=>1, 'enabled'=>!getDolGlobalInt('PRODUIT_MULTIPRICES'), 'position'=>40),
