...
/**
 * \file    modulebuilder/template/core/boxes/discountruleswidget1.php
 * \ingroup discountrules
 * \brief   Widget provided by discountrules
 *
 ...
 */
class discountruleswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "discountrulesbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "discountrules@discountrules";
	 ...
	 */
	public $depends = array('discountrules');
	...
	public function loadBox($max = 5)
	{
		...
		$this->info_box_head = array(
			...
			'subpicto' => 'object_discountrules@discountrules',
